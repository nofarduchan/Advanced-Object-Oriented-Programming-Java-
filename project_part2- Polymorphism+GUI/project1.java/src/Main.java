        ...
        for (i = 0; i < size; i++) {
            ...
            switch (option) {
                ...
                case 6: {
                    ...
                    wayType = sc.next();
                    v[i] = new Bicycle(model, maxSpeed, numPass, wayType);
                    break;
                }
                case 7: {
                    System.out.print("Enter model ");
                    ...
                    System.out.print("Enter engine life ");
                    engineLife = sc.nextInt();
                    v[i] = new CruiseShip(model, maxSpeed, numPass, flag, fuelConsumption, engineLife);
                    break;
                }
                default: {
            ...
            switch (option) {
                case 1: {
                    ...
                    if (type == 1) {
                        ...
                        System.out.print("Enter distance ");
                        distance = sc.nextInt();
                        Vehicle choice = new Bicycle(model, maxSpeed, numPass, wayType);
                        if (delete(size, choice, v, distance))
                        {
                            counter++;
                            size = size-1;
                        ...
                        System.out.print("Enter distance ");
                        distance = sc.nextInt();
                        Vehicle choice = new CruiseShip(model, maxSpeed, numPass, flag, fuelConsumption, engineLife);
                        if (delete(size, choice, v, distance))
                        {
                            counter++;
                            size = size-1;
