...
public class Cruise_Ship extends Marine implements Motorized, Commercial{
    private int fuelConsumption;
    private int engineLife;
    private String licenseType;
    public Cruise_Ship(String model, int maxSpeed, int numPass, String flag, int fuelConsumption, int engineLife) {
        /**
