...
public class Electric_Bicycle extends All_Bicycle implements Motorized{
    private int fuelConsumption;
    private int engineLife;
    public Electric_Bicycle(String model, int maxSpeed, int numPass, String wayType, int engineLife) {
